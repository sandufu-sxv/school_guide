...
public class CodeGenerator {
    ...
    // datasource
    private final static String URL = "jdbc:mysql://localhost:3306/school_guide?serverTimezone=GMT%2B8&allowMultiQueries=true&characterEncoding=UTF-8";
    private final static String DRIVER = "com.mysql.cj.jdbc.Driver";
    private final static String USERNAME = "root";
    private final static String PASSWORD = "123456";


    private final static String PARENT = "com.jiang";
    private final static String TEMPLATE_PATH = "/templates/mapper.xml.ftl";

//    private final static String TABLE_NAMES = "role";
    private final static String TABLE_NAMES = "back_information,reply_like";
...
//        strategy.setSuperControllerClass("com.baomidou.ant.common.BaseController");
        ...
        strategy.setSuperEntityClass("com.jiang.school_guide.common.domain.BaseEntity");
